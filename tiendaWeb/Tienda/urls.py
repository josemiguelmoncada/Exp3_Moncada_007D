...
urlpatterns = [
    ...
    path('api/productos/', views.ProductoList.as_view(), name='api_productos'),
    path('api/exportar_productos/', views.exportarJSON, name='exportar_productos'),
    path(r'productos/', views.mostrar_productos, name='productos'),
